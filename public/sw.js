const CACHE='vrf-guide-v4';
const ASSETS=['/','/styles.css','/app.js','/lg-reference-update.js','/field-diagnostics-v2.js','/manufacturer-app-data-v1.js','/service-tool.js','/manifest.webmanifest'];
