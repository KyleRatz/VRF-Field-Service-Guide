const CACHE='vrf-guide-v5';
const ASSETS=['/','/styles.css','/triangle.css','/app.js','/lg-reference-update.js','/field-diagnostics-v2.js','/manufacturer-app-data-v1.js','/service-tool.js','/triangle-engine.js','/manifest.webmanifest'];
