...
function fieldData(){
 ...
 const scheduled=summarizeUsage(yearEvents);
 const yearCapacity=capacitySummary(yearEvents,usageStart,yearEnd);
 ...
 const capacity=capacitySummary(future,today,horizon);
